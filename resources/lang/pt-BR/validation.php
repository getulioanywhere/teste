...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'city_id' => 'cidade',
        'city' => 'cidade',
        'suggestion' => 'reclamação/sugestão',
        'reason' => 'motivo',
        'title' => 'título',
        'cancelation_reason' => 'motivo do cancelamento',
        'refusal_reason' => 'motivo da recusa',
        'privacy_policy_consent' => 'consentimento de política de privacidade',
        'question' => 'pergunta',
        'name_seller' => "nome da loja",
        'student_invite_limit' => 'alunos',
        'technician_invite_limit' => 'técnicos',
        'client_invite_limit' => 'clientes',
        'company' => "Empresa",
        'cnpj' => "CNPJ",
        'document_cnpj' => "CNPJ",
        'cpf' => "CPF",
        ...
        'number' => 'número',
        'address' => 'endereço',
        'image_self' => 'foto de perfil',
        'city' => 'cidade',
        'neighborhood' => 'bairro',
        'subject' => 'assunto',
        'allowed_clients' => 'personagens permitidos',
        'client_types' => 'tipos de personagens',
        'penalty_weight' => 'peso da penalidade',
        'key' => 'chave/identificação',
        'penalty_reason' => 'razão da penalidade',
        'image' => 'imagem',
        'content' => 'conteúdo',
        'seller_token' => 'código do lojista',
